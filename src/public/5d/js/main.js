        ...
        for (let i = 0; i < arr2.length; i++) {
          ...
          <div data-v-42f27458="">
              <span data-v-42f27458="" style="color: rgb(0, 0, 0);">
                ...
                join += `
          <div data-v-42f27458="">
            <span data-v-42f27458="" style="color: rgb(0, 0, 0);">${(arr2[i] == 'c') ? "Chẵn" : (arr2[i] == 'l') ? 'Lẻ' : (arr2[i] == 'b') ? 'Lớn' : 'Nhỏ'}</span>
          </div>
          `;
            }
        }
      ...
      <div data-v-42f27458="" issuenumber="${data.id_product}" addtime="${timerJoin(data.time)}" rowid="1" class="hb">
              ...
              <div data-v-42f27458="" class="c-row c-row-between info">
                  <div data-v-42f27458="">
                      <div data-v-42f27458="" class="issueName">
                        ...
                        style="display: ${(data.status == 0) ? 'none' : ''};">${(data.status == 1) ? 'Thành công' : 'Thất bại'}</span>
                          <!---->
                      </div>
          ...
          <div data-v-42f27458="" class="details display-none">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458="" class="${(data.status == 1) ? 'green' : 'red'}" style="display: ${(data.status == 0) ? 'none' : ''};">${(data.status == 1) ? 'Thành công' : 'Thất bại'}</div>
                  <!---->
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
